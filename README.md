<div align="center">
  ...
  [![Resume](https://img.shields.io/badge/Resume-blue?style=for-the-badge&logo=adobeacrobat)](https://drive.google.com/file/d/1z4nZiqDYGfKOwn9hC9LbEC70_ELA31J1/view?usp=sharing)
...
- **Front-End:** React.js, Next.js, Vue.js, Vite, HTML5
- **Styling & UI:** Tailwind CSS, ShadCN UI, MUI (Material UI)
- **Back-End & API:** Django REST Framework, Express.js, REST API Integration, WebSockets
- **Machine Learning:** TensorFlow, PyTorch, scikit-learn, Convolutional Neural Networks (CNN)
- **Image Processing:** OpenCV, Pillow, NumPy
- **Analytics:** Predictive Modeling
- **Database:** PostgreSQL
- **DevOps & Deployment:** Docker, Git (GitHub, GitLab), Vercel, Railway, Netlify
- **Design:** Figma, Canva, GIMP, UI Prototyping
- **Other Skills:** Team Collaboration, Leadership, Adaptability, Problem Solving, Critical Thinking, Attention to Detail, Time Management, Strong Work Ethic, Continuous Learning
